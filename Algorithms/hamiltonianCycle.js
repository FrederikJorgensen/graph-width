...
function createSolutionTypeForDegreeOne(childVertices, verticesDegrees, matching, tree) {
  const solutionType = [];
    ...
    if (tree.graph.isEdge(childVertex, tree.introducedVertex)) {
      ...
      switch (degreeOfW) {
        case 0:
          ...
          matching = updateMatching(matching, childVertex, tree.introducedVertex);
          solutionType.push(verticesDegrees, matching);
          return solutionType;
          break;
        case 1:
...
function createSolutionTypeForDegreeTwo(childVertices, verticesDegrees, matching, tree) {
...
function createTableForIntroduceNode(partialSolutions, tree) {
  ...
  partialSolutions.forEach((partialSolution) => {
    for (let i = 0; i <= 2; i++) {
      ...
      switch (i) {
        case 0:
          solutionType = createSolutionTypeForDegreeZero(verticesDegrees, matching, tree);
          break;
        case 1:
          solutionType = createSolutionTypeForDegreeOne(childVertices, verticesDegrees, matching, tree);
          break;
        case 2:
          solutionType = createSolutionTypeForDegreeTwo(childVertices, verticesDegrees, matching, tree);
          break;
        default:
          break;
      }
  ...
  tree.root.eachAfter((currentNode) => {
    ...
    switch (tree.nodeType) {
      ...
      case 'forget':
        ...
        node.table = createTableForForgetNode(partialSolutions, tree.forgottenVertex);
        break;
      case 'join':
        break;
      default:
